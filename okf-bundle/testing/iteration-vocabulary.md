...
| E2e-only detail, emulator, suite scope | [running e2e](running-e2e.md) |
...
E2e scope and rules: [change authoring § validation tiers](change-authoring-workflow.md#validation-tiers), [running e2e](running-e2e.md).
